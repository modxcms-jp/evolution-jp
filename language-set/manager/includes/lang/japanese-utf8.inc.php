...
$_lang["access_permissions_introtext"] = 'ユーザーグループとドキュメントグループを管理します。ここでユーザーグループまたはドキュメントグループを作ると、ユーザ編集画面またはドキュメント編集画面で所属グループを選択できるようになります。また、ユーザーグループとドキュメントグループをここで関連付けることができます。つまり誰がどのドキュメントをという関連付けをここで行ないます。<br />※「グローバル設定」→「詳細設定」の「アクセス権限設定の使用」を「いいえ」にすると、グループ設定を経由しない運用になります。信用できる少数のメンバーでシンプルにサイトを管理運用したい場合は参考にしてください。';
...
$_lang["access_permissions_users_tab"] = 'ユーザーグループの設定一覧を表示します。グループの作成・リネーム・削除もここで操作します。また、ユーザーがどのグループのメンバーになっているかを閲覧することができます。ユーザーをグループに追加したり、グループから削除するには、ユーザーを直接編集してください。<br />※管理者(役割ID 1が割り当てられているユーザー)は常に全てのドキュメントにアクセスすることができるため、管理者をグループに追加する必要はありません。';
...
$_lang["administrator_role_message"] = 'この役割は編集、削除できません。';
...
$_lang["confirm_delete_role"] = '本当にこの役割を削除してもよろしいですか?';
...
$_lang["role_management_msg"] = '役割ごとにアクセス可能な機能を選択・設定します。たとえば「管理者」「投稿者」といった役割を作る場合、「投稿者」はサイト管理に関する設定をさわれないように制限をかけます。役割は一般的には「ロール」とも呼ばれ、各ユーザごとに機能操作権限を直接割り当てるのではなく、役割化されたグループ単位で権限を割り当てる考え方となっています。';
$_lang["role_management_title"] = '役割管理';
...
$_lang["role_role_management"] = '役割管理';
