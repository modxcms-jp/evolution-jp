...
$_lang["configcheck_errorpage_unavailable_msg"] = '設定した「エラーページ」が一般的なエンドユーザーからアクセスできないページ（private）かあるいは存在しないことを意味しています。これはシステムがループ状態を陥り、多くのエラーメッセージをエラーログに刻むでしょう。「エラーページ」には存在するページでかつ、公開ページ、かつ「public」なページを指定してください。';
...
$_lang["rss_url_news_message"] = '「MODx News」のフィードURL.';
$_lang["rss_url_news_title"] = 'RSS News Feed';
$_lang["rss_url_security_message"] = '「MODx Security」のフィードURL';
