...
$_lang['DM_sort_nochildren'] = 'このドキュメントにはサブドキュメントがありません。';
...
$_lang['DM_select_range_text'] = '<p><strong>指定方法（n・m はドキュメントIDを示す数字です):</strong></p><br />
						<ul><li>n*　 - そのドキュメント（フォルダ）と直下のサブドキュメント</li>
							<li>n** - そのドキュメント（フォルダ）と配下の子、孫など全てのドキュメント</li>
							<li>n-m - n から m までを指定。n・m を含みます</li>
							<li>n　　 - IDがnのドキュメントを単独で指定</li>
							<li>例：1*,4**,2-20,25　- この指定では、1、1のサブドキュメント、4、4の全配下ドキュメント、
