MODx(tm) CMS free software targeted at developers, licensed under the GPL.
Download the latest version and obtain support at http://modxcms.com/
Copyright 2005-2007 the MODx CMS project. All rights reserved.
MODx and MODx CMS are trademarks of the MODx Project.
...
----------------------------------
You should be able to upgrade to the latest version from any prior MODx version. For detailed instructions and best practices, please see our wiki for some best practices for upgrading from previous versions:
...
You can also optionally delete the README.xx.txt files located in the root of your MODx install location (which includes this file you're reading).
