        ...
        <tr>
          ...
          <table border="0" width="100%">
            ...
            <tr>
              ...
              <a href="[+action+]"><img align="top" src="captcha.php?rand=<?php echo mt_rand(); ?>" width="148" height="60" alt="If you have trouble reading the code, click on the code itself to generate a new random code." style="border: 1px solid #003399"></a>
              </td>
            </tr>
            <?php } ?>
            <tr>
