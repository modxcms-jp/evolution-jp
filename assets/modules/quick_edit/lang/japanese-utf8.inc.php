...
$QE_lang['close'] = '閉じる';
$QE_lang['document_title'] = 'ドキュメント名';
$QE_lang['document_title_help'] = 'ドキュメント名を入力します。バックスラッシュは使えません。';
$QE_lang['long_title'] = 'タイトル';
$QE_lang['document_long_title_help'] = 'このページのタイトルを入力します。';
