...
?>
    ...
    $mainPane = sprintf('<frame name="main" src="%s" scrolling="auto" frameborder="0" onload="if(top && top.mainMenu && typeof top.mainMenu.stopWork === \'function\') top.mainMenu.stopWork();">',
    $mainurl);
    ?>
