...
<head>
    ...
    ---------------------------------------------------------------- */
        ...
        .header {padding: 5px 3px 5px 18px;font-weight: bold;color: #000;background: linear-gradient(180deg, #f7f9fc 0%, #e7ecf4 100%);border-bottom:1px solid #e0e0e0;}
        .body {padding: 20px 20px 20px;display: block;background: #fff;    box-shadow: inset 0px 5px 10px 0px rgba(70, 70, 70, 0.1);}
        ...
        form input.text, input#FMP-email {margin-bottom:8px;line-height:1;ime-mode:inactive;letter-spacing:1px;font-family: Verdana; width: 400px;background: linear-gradient(180deg, #ffffff 0%, #eef3fb 100%);border:1px solid #ccc;padding:3px;}
        input.login {float: right;clear: right;margin-right: 0px;padding:5px 8px;cursor: hand; cursor: pointer;background: linear-gradient(180deg, #5fa2e6 0%, #4b85d6 100%);border:1px solid #3f6fab;color: #fff;}
        ...
        .loginBrand {font-weight:bold;font-size:1.2em;color:#1f2937;margin-bottom:10px;}
    </style>
...
<div id="mx_loginbox">
    <form method="post" name="loginfrm" id="loginfrm" action="processors/login.processor.php">
        ...
        <div class="body">
            <div class="loginBrand" id="logo">[+site_name+]</div>
