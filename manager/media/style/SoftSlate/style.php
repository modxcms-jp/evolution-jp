...
$asset_style_path = 'media/style/RevoStyle/';

// Tree Menu Toolbar
$icon_path = $asset_style_path . 'images/icons/';
...
// Tree Icons
$tree_path = $asset_style_path . 'images/tree/';
...
// Miscellaneous
$_style['ajax_loader'] = '<p>' . $_lang['loading_page'] . '</p><p><img src="' . $asset_style_path . 'images/misc/ajax-loader.gif" alt="Please wait" /></p>';
$_style['tx'] = $asset_style_path . 'images/misc/_tx_.gif';
