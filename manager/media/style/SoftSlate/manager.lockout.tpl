...
} input {margin: 0 0 10px 0;} input.login {float: right;clear: right;margin-right: 0px;padding:5px 8px;cursor: hand; cursor: pointer;background: linear-gradient(180deg, #5fa2e6 0%, #4b85d6 100%);border:1px solid #3f6fab;color: #fff;} .loginLicense {width: 460px;color: #B2B2B2;margin: 0.5em auto;font-size: 90%;padding-left: 20px;} .loginLicense a {color: #B2B2B2;} .loginMessage {font-size:12px;color: #999;padding-top: 10px;} #loginfrm
...
<div id="mx_loginbox">
    <form method="post" name="loginfrm" id="loginfrm" action="processors/login.processor.php">
        ...
        <!-- the logo -->
        <div id="mx_logobox">
            <div class="loginBrand" id="logo">[+logo_slogan+]</div>
        </div>
        <!-- end #mx_logobox -->
