...
$tab_your_info = $tab_your_info ?? 1;
$tab_online = $tab_online ?? 1;

$iconResources = $iconResources ?? 1;
$iconNewDoc = $iconNewDoc ?? 1;
$iconSearch = $iconSearch ?? 1;
$iconMessage = $iconMessage ?? 1;

$iconElements = $iconElements ?? 1;
$iconSettings = $iconSettings ?? 1;
$iconFileManager = $iconFileManager ?? 1;
$iconEventLog = $iconEventLog ?? 1;
$iconSysInfo = $iconSysInfo ?? 1;
$iconHelp = $iconHelp ?? 1;

$revoMenuHeight = $revoMenuHeight ?? 86;
...
// Tree Menu Toolbar
apply_tree_toolbar_style_defaults($icon_path, $_style);
