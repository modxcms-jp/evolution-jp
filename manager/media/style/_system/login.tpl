...
<head>
    ...
    <style type="text/css">
        ...
        ---------------------------------------------------------------- */
        html, body, form, fieldset {margin: 0;padding: 0;} html {
        ...
        body {height:auto;font-size: 75%; /* 12px 62.5% for 10px*/margin-bottom: 1px;background-color:#EEEEEE;} img, a img {border: 0 !important;text-decoration: none;padding: 0;margin: 0;} input {font:inherit;} h1, h2, h3, h4, h5, h6, p, pre,
        blockquote, ul, ol, dl, address {margin: 0 0 .5em; /* Reset vertical margins on selected elements */padding: 0;} li, dd, blockquote {margin-left: 1em; /* Left margin only where needed */} /* Headers and Paragraphs:
    ---------------------------------------------------------------- */
        h1, h2, h3, h4, h5, h6 {font-weight: normal;} h1 {
            font-size: 218%;
        }
        ...
        .header {padding: 5px 3px 5px 18px;font-weight: bold;color: #000;background-color: #EAECEE;border-bottom:1px solid #e0e0e0;} .body {padding: 20px 20px 20px;display: block;background: #fff;
    box-shadow: inset 0px 5px 10px 0px rgba(70, 70, 70, 0.1);} #mx_loginbox {width: 460px;margin: 30px auto 0;
                                 box-shadow: 0 0 10px #aaa;
                             -moz-box-shadow: 0 0 10px #aaa;
                             -webkit-box-shadow: 0 0 15px #ccc;
} img.loginCaptcha {border: 1px solid #039;width: 148px;height: 60px;} label {display: block;font-weight: bold;} input {margin: 0 0 10px 0;} input.checkbox {float: left;clear: left;margin-right: 3px;} form input.text, input#FMP-email {margin-bottom:8px;line-height:1;ime-mode:inactive;letter-spacing:1px;font-family: Verdana; width: 400px;background-color: #fff;border:1px solid #ccc;padding:3px;} input.login {float: right;clear: right;margin-right: 0px;padding:5px 8px;cursor: hand; cursor: pointer;background-color: #EAECEE;border:1px solid #ccc;} .loginLicense {width: 460px;color: #B2B2B2;margin: 0.5em auto;font-size: 90%;padding-left: 20px;} .loginLicense a {color: #B2B2B2;} .loginMessage {font-size:12px;color: #999;padding-top: 10px;} input#FMP-email {width:300px;} label#FMP-email_label
    ...
    <form method="post" name="loginfrm" id="loginfrm" action="processors/login.processor.php">
        ...
        <div class="body">
            ...
            <input type="checkbox" id="rememberme" name="rememberme" tabindex="4" value="1" class="checkbox"
                   [+remember_me+]/><label for="rememberme"
                                           style="cursor:pointer;display:inline;">[+remember_username+]</label>
