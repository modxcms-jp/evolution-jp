...
function getTVDisplayFormat($name,$value,$format,$paramstring='',$tvtype='',$docid='', $sep='')
		{global $modx;return $modx->outputFilter($value,$format,$paramstring,$name,$tvtype,$docid,$sep);}
...
function parseInput($src, $delim='||', $type='string', $columns=true)
		{global $modx;return $modx->parseInput($src, $delim, $type, $columns);}
function getUnixtimeFromDateString($value)
		{global $modx;return $modx->getUnixtimeFromDateString($value);}
