...
$_lang['resource_tree_node_name_title'] = 'Имя ресурса в дереве документов';
...
$_lang['cache_type_message'] = 'Выбор "Кеш отключен" отключит все кеширование. Не рекомендуется';
