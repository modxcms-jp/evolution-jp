<?php
/**
* Filename:       includes/lang/japanese-euc.inc.php
...
define('MAGPIE_OUTPUT_ENCODING', 'eucJP');
...
$_lang["format_date"] =           '%m/%d';
$_lang["format_date_long"] =      '%Y/' . $_lang["format_date"];
$_lang["format_datetime"] =       '%Y/' . $_lang["format_date"] . ' %H:%M';
$_lang["format_datetime_full"] =  '%Y/' . $_lang["format_date"] . ' %H:%M:%S';
$_lang["friday"] = '金曜';
...
$_lang["friendlyurls_message"] = '静的URI機能（フレンドリーURL）の設定を行います。この機能はMODxがApache上で動作している時のみ有効です。この機能を動作させるために .htaccessファイルに簡単な編集を加える必要があります。詳細は同梱 .htaccessファイルの末尾あたりをご覧ください。';
