...
$_lang["htmlsnippet_msg"] = '<p>チャンク名には日本語を用いることができます。</p>';
...
$_lang["template_msg"] = 'テンプレートを作成/編集します。通常のhtmlに埋め込む独自タグとして、テンプレート変数(リソース変数含む)・コンフィグ変数・リンクタグ・スニペット・チャンク・ベンチマークタグなどを記述できます。';
...
$_lang["tmplvars_management_msg"] = '<h3 style="font-weight:bold;">テンプレート変数の管理</h3>一般的なCMSでいうところのカスタムフィールドに相当するもので、MODXはこの機能が非常に柔軟・強力です。「タイトル」や「内容」などの既定の項目に加え、投稿画面上に自由に項目を追加できます。テンプレート内の任意の場所に <strong>[*テンプレート変数名*]</strong> と記述すると値を出力できます。';
