...
$_lang["create_resource_here"] = 'サブリソースを作成';
...
$_lang["move_resource_new_parent"] = '移動先の親リソースを左のサイトツリーから選択してください';
...
$_lang["resource_parent_help"] = '上のコンテナアイコンをクリックすると、このリソースの親(コンテナ)を選択できる状態になります。アイコンが変化している状態で、親にしたいリソースをサイトツリー上でクリックしてください。もう一度クリックすると元に戻ります。';
...
$_lang["tree_page_click_message"] = 'サイトツリーをクリックした時の既定の動作を設定します。「自動」を選ぶとリソースがコンテナかどうかで判定します。';
