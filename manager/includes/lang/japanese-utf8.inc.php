...
$_lang["errorpage_message"] = 'リソースが存在しない場合のエラーページ(404 ページ)として表示する、リソースのIDを入力してください。このページは実際にステータスコード404を出力します。<br /><strong>注意: 既に存在するリソースのIDを入力してください。リソースは公開されている必要があります。</strong>';
...
$_lang["siteunavailable_page_message"] = 'サイト閉鎖中に表示するリソースのIDをここに入力してください。<br /><strong>注意: 既に存在するリソースのIDを入力してください。リソースは公開されている必要があります。</strong>';
