...
$_lang["showing"] = '表示中';
$_lang["signupemail_message"] = 'ユーザ管理画面でユーザーアカウントを作成した時に、ログイン名とパスワードを記載したメールを送信することができます。このメールの内容は変更できます<br /><strong>参考:</strong> 下記の差し込み文字列は送信時に自動的に置き換えられます。<br /><br />[(site_name)] - サイトの名前<br />[(emailsender)] - サイト管理者のメールアドレス<br />[(site_url)] - サイトのURL<br />[+username+] - ログイン名<br />[+password+] - パスワード<br />[+fullname+] - フルネーム';
...
$_lang["webpwdreminder_message"] = 'ウェブユーザーからパスワード変更の要求があった時に、MODXは新パスワードとアクティベーション方法を記載したメールを送信することができます。このメールの内容は変更できます。<br /><strong>参考:</strong> 下記の差し込み文字列は送信時に自動的に置き換えられます。<br /><br />[(site_name)] - サイトの名前<br />[(emailsender)] - サイト管理者のメールアドレス<br />[(site_url)] - サイトのURL<br />[+username+] - ログイン名<br />[+password+] - パスワード<br />[+fullname+] - フルネーム';
$_lang["webpwdreminder_title"] = 'パスワード変更<br />リクエストメール';
$_lang["websignupemail_message"] = 'ユーザー自らがウェブユーザーアカウントを作成した時に、MODXはログイン名とパスワードを記載したメールを送信することができます。このメールの内容は変更できます。<br /><strong>参考:</strong> 下記の差し込み文字列は送信時に自動的に置き換えられます。<br /><br />[(site_name)] - サイトの名前<br />[(emailsender)] - サイト管理者のメールアドレス<br />[(site_url)] - サイトのURL<br />[+username+] - ログイン名<br />[+password+] - パスワード<br />[+fullname+] - フルネーム';
