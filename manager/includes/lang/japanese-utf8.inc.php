...
$_lang["filemanager_path_message"] = '<a href="index.php?a=31">「ファイル管理」</a>で扱える範囲を決定します。コンテンツ編集に利用するファイルブラウザと違い、同じサーバ内で権限を持つ領域であればどのディレクトリでも管理できます。';
...
$_lang["rb_base_dir_message"] = 'アセットディレクトリ(通常はassetsディレクトリ)の物理パスです。';
$_lang["rb_base_dir_title"] = 'アセットディレクトリの<br />物理パス ';
$_lang["rb_base_url_message"] = 'アセットディレクトリ(通常はassetsディレクトリ)のパスです。MODx設置ディレクトリを基準とした相対パスを記述します。';
