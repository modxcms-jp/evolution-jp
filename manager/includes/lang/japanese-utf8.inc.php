...
$_lang["htmlsnippet_management_msg"] = '<h3 style="font-weight:bold;">チャンクの管理</h3>チャンクはテキストのパーツです。テンプレートやリソース(投稿画面)に<strong>{{チャンク名}}</strong>と記述すると、そのチャンクの内容を出力します。スニペット・プラグイン・モジュールからチャンクを参照したい場合は $modx-&gt;getChunk(\'チャンク名\')として呼び出します。';
$_lang["htmlsnippet_msg"] = '<p>チャンクはテキストのパーツです。テンプレートやリソース(投稿画面)に<strong>{{チャンク名}}</strong>と記述すると、そのチャンクの内容を出力します。スニペット・プラグイン・モジュールからチャンクを参照したい場合は $modx-&gt;getChunk(\'チャンク名\')として呼び出します。</p>';
