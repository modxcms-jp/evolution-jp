...
$_lang['setting_event_log_enable_file'] = 'イベントログをテキスト出力';
$_lang['setting_event_log_enable_file_desc'] = '有効にすると、イベントログに保存した内容を指定したテキストファイルにも追記します。';
$_lang['setting_event_log_file_path'] = 'イベントログの保存先パス';
$_lang['setting_event_log_file_path_desc'] = '相対パスは MODX のベースパスからの相対指定として処理します。必要に応じてディレクトリは自動的に作成されます。';
