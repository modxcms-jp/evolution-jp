...
$_lang["captcha_message"] = 'OCRソフトで自動的に読み取ることが難しい文字列を画像で表示し、ユーザーの入力を求めます。これによりセキュリティを強化することができます。';
...
$_lang["preview_resource"] = '表示を確認 (別窓)';
...
$_lang["uploadable_flash_message"] = 'ファイルブラウザを使用して「assets/flash/ 」にアップロードできるフラッシュファイルの拡張子を入力してください。カンマで区切って入力してください。';
$_lang["uploadable_flash_title"] = 'アップロード可能なフラッシュ ';
$_lang["uploadable_images_message"] = 'ファイルブラウザを使用して「assets/images/ 」にアップロードできる画像ファイルの拡張子を入力してください。カンマで区切って入力してください。';
$_lang["uploadable_images_title"] = 'アップロード可能な画像タイプ ';
$_lang["uploadable_media_message"] = 'ファイルブラウザを使用して「assets/media/ 」にアップロードできるメディアファイルの拡張子を入力してください。カンマで区切って入力してください。';
