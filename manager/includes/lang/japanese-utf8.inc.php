...
$_lang['element_php_error_reporting'] = 'PHPエラー検出レベル（要素別）';
$_lang['element_php_error_reporting_inherit'] = 'グローバル設定を継承';
$_lang['element_php_error_reporting_msg'] = 'この要素に適用するPHPエラー検出レベルを設定します。継承を選択するとグローバル設定が適用されます。';
