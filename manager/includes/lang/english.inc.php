...
$_lang["site_unavailable_message"] = 'Message to show when the site is offline or if an error occurs. <b>Note: This message will only be displayed if the Site unavailable page option is not set.</b>';
...
$_lang["site_unavailable_title"] = 'Site unavailable message';
