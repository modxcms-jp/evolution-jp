...
$_lang["use_captcha_message"] = 'Enable this to strengthen security by requiring users to enter a code which is unreadable by machines (and script-kiddy hacking scripts).';
$_lang["use_captcha_title"] = 'Use CAPTCHA codes';
...
$_lang["modx_charset_message"] = 'Select the default character encoding for the [(modx_charset)] system variable. This does not affect the Manager.';
$_lang["modx_charset_title"] = 'Character encoding';
$_lang["chunk"] = 'Chunk';
...
$_lang["clean_uploaded_filename_title"] = 'Use Transliteration for File Uploads';
...
$_lang["datepicker_offset_title"] = 'Datepicker offset';
$_lang["datepicker_offset_message"] = 'The number of years to show in the past on the datepicker.';
$_lang["datetime_format_title"] = 'Date format';
$_lang["datetime_format_message"] = 'The format for dates in the Manager.';
$_lang["default"] = 'Default:';
$_lang["cache_default_message"] = 'Select \'Yes\' to make all new Resources cacheable by default.';
$_lang["cache_default_title"] = 'Cacheable default';
$_lang["auto_menuindex_message"] = 'Select \'Yes\' to turn on automatic menu index incrementing by default.';
$_lang["auto_menuindex_title"] = 'Menu indexing default';
$_lang["publish_default_message"] = 'Select \'Yes\' to make all new Resources published by default.';
$_lang["publish_default_title"] = 'Published default';
$_lang["search_default_message"] = 'Select \'Yes\' to make all new Resources searchable by default.';
$_lang["search_default_title"] = 'Searchable default';
$_lang["default_template_message"] = 'Select the Template you wish to use as a system default for new Resources. You can still select a different Template in the Resource editor, this setting just pre-selects one of your Templates for you.';
$_lang["default_template_title"] = 'System Default Template';
$_lang["auto_template_logic_title"] = 'Automatic Template Assignment';
$_lang["auto_template_logic_message"] = 'New Resources will have the following templates, falling back to higher levels if not found:';
...
$_lang["allow_duplicate_alias_message"] = 'Select \'yes\' to allow duplicate URL aliases to be saved. <b>NOTE: This option should be used with \'Friendly URL alias path\' option set to \'Yes\' in order to avoid problems when referencing a Resource.</b>';
$_lang["allow_duplicate_alias_title"] = 'Allow duplicate URL aliases';
...
$_lang["error_page_message"] = 'Enter a published and publicly accessible Resource ID to redirect users to when requesting a non-existing Resource.';
$_lang["error_page_title"] = 'Error page';
...
$_lang["failed_login_attempts_message"] = 'Enter the number of failed login attempts allowed before blocking a user.';
$_lang["failed_login_attempts_title"] = 'Failed Login Attempts';
...
$_lang["friday"] = 'Friday';
$_lang["friendly_alias_urls_message"] = 'With Friendly URLs enabled, a Resource URL alias will be used when present instead of the Resource ID. E.g., if a Resource with ID 1 has an URL alias of "introduction", no prefix set (empty) and a suffix of ".html", enabling this option would generate an URL alias of  "introduction.html". If there is no URL alias set, MODX generates "1.html".';
$_lang["friendly_alias_urls_title"] = 'Use Friendly URL aliases';
$_lang["friendly_urls_message"] = 'Use Search Engine Friendly URLs on Apache webservers with mod_rewrite or IIS with third-party plugins. See the .htaccess file in the site root of the distribution for more info.';
$_lang["friendly_urls_title"] = 'Use FriendlyURLs';
$_lang["friendly_url_prefix_message"] = 'A prefix setting of "page" will turn the URL /index.php?id=2 to the URL alias "page2.html" (assuming the suffix is set to .html).';
$_lang["friendly_url_prefix_title"] = 'Friendly URL Prefix';
$_lang["friendly_url_suffix_message"] = 'Any suffix you choose will work, including no suffix at all. E.g., ".aspx" will append .aspx to all URL aliases.';
$_lang["friendly_url_suffix_title"] = 'Friendly URL Suffix';
...
$_lang["number_of_logs_message"] = 'Enter the number of log entries shown per page when you browse the Audit trail.';
$_lang["number_of_logs_title"] = 'Number of log entries';
$_lang["number_of_messages_message"] = 'Enter the number of messages to show in inbox when viewing messages.';
$_lang["number_of_messages_title"] = 'Number of messages';
$_lang["none"] = 'None';
$_lang["number_of_results_message"] = 'Enter the number of results to show in the data grid when viewing listings and search results.';
$_lang["number_of_results_title"] = 'Number of Results';
...
$_lang["use_browser_message"] = 'Select yes to enable the File Browser. This will allow your users to browse and upload files such as images, flash and media files on the server.';
$_lang["use_browser_title"] = 'Enable File Browser';
...
$_lang["server_offset_time_message"] = 'Select the number of hours time difference between where you are and where the server is. Current time on server is <b>[%s]</b>, current time on server using the currently saved offset is <b>[%s]</b>.';
$_lang["server_offset_time_title"] = 'Server offset time';
...
$_lang["signupemail_message_message"] = 'Set the email message sent to users when creating accounts including their username and password.<br /><b>Note:</b> The following Placeholders are replaced by the Content Manager when the message is sent: <br /><br />[(site_name)] - Name of your web site, <br />[(site_url)] - Your web site email address, <br />[(site_url)] - Your site url, <br />[+username+] - User\'s Login name or id, <br />[+password+] - User\'s password, <br />[+fullname+] - User\'s full name. <br /><br /><b>Leave the [+username+] and [+password+] in the e-mail, or else the username and password won\'t be sent in the mail and your users won\'t know their username or password!</b>';
$_lang["signupemail_message_title"] = 'Signup e-mail';
$_lang["site"] = 'Site';
$_lang["site_schedule"] = 'Schedule';
$_lang["site_name_message"] = 'Enter the name of your site here.';
$_lang["site_name_title"] = 'Site name';
$_lang["site_slogan_message"] = 'Please input slogan of a site. [(site_slogan)]';
$_lang["site_slogan_title"] = 'Site slogan';
$_lang["site_start_message"] = 'Enter the ID of the Resource you want to use as homepage here. <b>NOTE: make sure this ID you enter belongs to an existing Resource, and that it has been published!</b>';
$_lang["site_start_title"] = 'Site start';
$_lang["site_status_message"] = 'Select \'Online\' to publish your site on the web. If you select \'Offline\', your visitors will see the \'Site unavailable message\', and won\'t be able to browse the site.';
$_lang["site_status_title"] = 'Site status';
$_lang["site_unavailable_message_title"] = 'Site unavailable message';
$_lang["site_unavailable_message_message"] = 'Message to show when the site is offline or if an error occurs. <b>Note: This message will only be displayed if the Site unavailable page option is not set.</b>';
$_lang["site_unavailable_message_default"] = 'The site is currently unavailable.';
$_lang["site_unavailable_page_message"] = 'Enter the ID of the Resource you want to use as an offline page here. <b>NOTE: make sure this ID you enter belongs to an existing Resource, and that it has been published!</b>';
$_lang["site_unavailable_page_title"] = 'Site unavailable page';
...
$_lang["signupemail_message_default"] = "Hello [+username+] \n\nHere are your login details for [(site_name)] Content Manager:\n\nUsername: [+username+]\nPassword: [+password+]\n\nOnce you log into the Content Manager ([(site_url)]), you can change your password.\n\nRegards,\nSite Administrator";
$_lang["webpwdreminder_message_default"] = "Hello [+username+]\n\nTo activate your new password click the following link:\n\n[(site_url)]\n\nIf successful you can use the following password to login:\n\nPassword:[+password+]\n\nIf you did not request this email then please ignore it.\n\nRegards,\nSite Administrator";
$_lang["websignupemail_message_default"] = "Hello [+username+]\n\nHere are your login details for [(site_name)]:\n\nUsername: [+username+]\nPassword: [+password+]\n\nOnce you log into [(site_name)] ([(site_url)]), you can change your password.\n\nRegards,\nSite Administrator";
...
$_lang["use_udperms_message"] = 'Control access to Resources via User Groups and Resource Groups.';
$_lang["use_udperms_title"] = 'Use access permissions';
$_lang["unable_set_link"] = 'Unable to set the link!';
$_lang["unable_set_parent"] = 'Unable to set new parent!';
$_lang["unauthorized_page_message"] = 'Enter a published and publicly accessible Resource ID to redirect Users to when requesting a secured/unauthorized Resource.';
$_lang["unauthorized_page_title"] = 'Unauthorized page';
...
$_lang["upload_files_message"] = 'Enter a list of files that can be uploaded into \'assets/files/\' using the File Browser. Please enter the extensions for the filetypes, separated by commas.';
$_lang["upload_files_title"] = 'Uploadable File Types';
$_lang["upload_flash_message"] = 'Enter a list of files that can be uploaded into \'assets/flash/\' using the File Browser. Please enter the extensions for the flash types, separated by commas.';
$_lang["upload_flash_title"] = 'Uploadable Flash Types';
$_lang["upload_images_message"] = 'Enter a list of files that can be uploaded into \'assets/images/\' using the File Browser. Please enter the extensions for the image types, separated by commas.';
$_lang["upload_images_title"] = 'Uploadable Image Types';
$_lang["upload_media_message"] = 'Enter a list of files that can be uploaded into \'assets/media/\' using the File Browser. Please enter the extensions for the media types, separated by commas.';
$_lang["upload_media_title"] = 'Uploadable Media Types';
...
$_lang["warning_visibility_title"] = 'Configuration Warnings visible to';
...
$_lang["webpwdreminder_message_message"] = 'Enter a message to be sent to your Web Users whenever they request a new password via email. The Content Manager will send an e-mail containing their new password and activation information. <br /><b>Note:</b> The following Placeholders are replaced by the Content Manager when the message is sent: <br /><br />[(site_name)] - Name of your web site, <br />[(site_url)] - Your web site email address, <br />[(site_url)] - Your site url, <br />[+username+] - User\'s Login name or id, <br />[+password+] - User\'s password, <br />[+fullname+] - User\'s full name. <br /><br /><b>Leave the [+username+] and [+password+] in the e-mail, or else the username and password won\'t be sent in the mail and your Users won\'t know their username or password!</b>';
$_lang["webpwdreminder_message_title"] = 'Web Reminder Email';
$_lang["websignupemail_message_message"] = 'Set the email message sent to Users when creating accounts including their username and password<br /><b>Note:</b> The following Placeholders are replaced by the Content Manager when the message is sent: <br /><br />[(site_name)] - Name of your web site, <br />[(site_url)] - Your web site email address, <br />[(site_url)] - Your site url, <br />[+username+] - User\'s Login name or id, <br />[+password+] - User\'s password, <br />[+fullname+] - User\'s full name. <br /><br /><b>Leave the [+username+] and [+password+] in the e-mail, or else the username and password won\'t be sent in the mail and your Users won\'t know their username or password!</b>';
$_lang["websignupemail_message_title"] = 'Web Signup e-mail';
...
$_lang["send_errormail_title"] = 'email notifies system error.';
$_lang["mutate_settings.dynamic.php7"] = 'not notify';
$_lang["send_errormail_message"] = 'It notifies to [(emailsender)]([+emailsender+]) at the time of error generating. The details of the contents of the error should check an event log.';
...
$_lang['error_reporting_title'] = 'Detection level of the PHP error';
$_lang['error_reporting_message'] = 'Set the detection level of the PHP error.';
...
$_lang['output_filter_title'] = 'Output filter';
...
$_lang["image_limit_width_title"] = 'The maximum of the width of the image(px)';
$_lang["image_limit_width_message"] = 'Reduce the width of the image to upload automatically. Do not handle it when make a blank.';
...
$_lang["auto_sleep_user_title"] = 'Auto sleep inactive user';
$_lang["auto_sleep_user_message"] = 'When there is not manager login, in the days that set here, make an applicable user dormancy automatically.';
