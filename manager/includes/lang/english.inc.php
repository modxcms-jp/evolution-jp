...
$_lang["php_version_check"] = 'MODX Evolution is compatible with PHP version 7.4.0 and higher. This server is using version %s. Please upgrade your PHP installation!';
$_lang["plugin"] = 'Plugin';
