...
$_lang['setting_event_log_enable_file'] = 'Write event log to file';
$_lang['setting_event_log_enable_file_desc'] = 'When enabled, entries saved to the event log are also appended to the specified text file.';
$_lang['setting_event_log_file_path'] = 'Event log file path';
$_lang['setting_event_log_file_path_desc'] = 'Relative paths are resolved from the MODX base path. Directories are created automatically when needed.';
