...
class DocumentParser {
    ...
    */
    ...
    public function input_any($key = null, $default = null) {
        if ($rs = $this->input_post($key)) {
            return $rs;
        }
        if ($rs = $this->input_get($key)) {
            return $rs;
        }
        if ($rs = $this->input_cookie($key)) {
            return $rs;
        }
        return $default;
    }
