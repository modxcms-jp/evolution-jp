...
<div id="actions">
	  <ul class="actionButtons">
		  ...
		  <?php } ?>	
          <li id="Button4"><a href="#" onclick="documentDirty=false;<?php echo $content['parent']==0 ? "document.location.href='index.php?a=2';" : "document.location.href='index.php?a=3&amp;id=" . $content['parent'] . "';"?>"><img alt="icons_cancel" src="<?php echo $_style["icons_cancel"] ?>" /> <?php echo $_lang['cancel']?></a></li>
          <?php
            if ($_REQUEST['a'] !== '4' && $_REQUEST['a'] !== '72') { ?>
	...
	<div class="tab-page" id="tabSettings">
		...
		<?php $mx_can_pub = $modx->hasPermission('publish_document') ? '' : 'disabled="disabled" '; ?>
			...
			<tr style="height: 24px;">
                ...
                <a onclick="javascript:document.mutate.pub_date.value=''; return true;" onmouseover="window.status='<?php echo $_lang['remove_date']?>'; return true;" onmouseout="window.status=''; return true;" style="cursor:pointer; cursor:hand;">
