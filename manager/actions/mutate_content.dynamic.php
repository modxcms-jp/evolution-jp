...
<div class="tab-pane" id="documentPane">
	...
	<div class="tab-page" id="tabGeneral">
		...
		<table border="0" cellspacing="0" cellpadding="0">
			...
			<tr style="height: 24px;"><td width="130" align="left"><span class="warning"><?php echo $_lang['document_title']?></span></td>
	...
	<div class="tab-page" id="tabTV">
		...
		<script type="text/javascript">tpSettings.addTabPage( document.getElementById( "tabTV" ) );</script>
...
?>&nbsp;<img name="plock" src="media/style/<?php echo $manager_theme?>images/tree/folder.gif" width="18" height="18" onclick="enableParentSelection(!allowParentSelection);" style="cursor:pointer;" /><b><span id="parentName"><?php echo isset($_REQUEST['pid']) ? $_REQUEST['pid'] : $content['parent']?> (<?php echo $parentname?>)</span></b><br />
				<span class="comment" style="display:block;"><?php echo $_lang['document_parent_help']?></span>
...
<?php if ($modx->hasPermission('edit_doc_metatags')) {
	...
	<div class="tab-page" id="tabMeta">
		...
		<table border="0" cellspacing="0" cellpadding="0">
		<tr style="height: 24px;"><td colspan="2"><?php echo $_lang['document_metatag_help']?><br /><br />
...
?>				</select>
				<br />
				<input type="button" class="button" value="<?php echo $_lang['deselect_keywords']?>" onclick="clearKeywordSelection();" />
			</td>
