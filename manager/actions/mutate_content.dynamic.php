...
function tooltip($msg)
{
	...
	$ph['msg'] = $msg;
	$tpl = '&nbsp;&nbsp;<img src="[+icons_tooltip_over+]" onmouseover="this.src=[+icons_tooltip+];" onmouseout="this.src=\'[+icons_tooltip_over+]\'" alt="[+msg+]" title="[+msg+]" onclick="alert(this.alt);" style="cursor:help;" class="tooltip" />';
	return $modx->parsePlaceholder($tpl,$ph);
}
