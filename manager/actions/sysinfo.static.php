...
<div class="sectionHeader"><?php echo $_lang["activity_title"]; ?></div><div class="sectionBody" id="lyr1">
		...
		if($limit<1) {
			...
			for ($i = 0; $i < $limit; $i++) {
				...
				echo "<tr bgcolor='$bgcolor'><td>".$content['id']."</td><td><a href='index.php?a=3&id=".$content['id']."'>".$content['pagetitle']."</a></td><td>".$user."</td><td>".strftime($_lang["format_datetime_full"], $content['editedon']+$server_offset_time)."</td></tr>";
			}
		}
		?>
		</tbody>
