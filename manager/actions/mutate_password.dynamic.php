...
<div class="sectionBody">
	...
	<tr>
		...
		<td><input onchange="documentDirty=true;" type="password" name="pass1" class="inputBox" style="width:150px" value="" autocomplete="off" /></td>
	</tr>
	<tr>
		<td><?php echo $_lang['change_password_confirm']?>:</td>
		<td><input onchange="documentDirty=true;" type="password" name="pass2" class="inputBox" style="width:150px" value="" autocomplete="off" /></td>
	</tr>
	</table>
