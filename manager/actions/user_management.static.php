	...
	<div class="actionButtons">
		<table border="0" style="width:100%">
			...
			<td nowrap="nowrap">
				...
				<td><a href="#" title="<?php echo $_lang["reset"];?>" onclick="resetSearch();return false;"><img src="<?php echo $style_path; ?>icons/refresh.gif" width="16" height="16"/></a></td>
				<td><a href="#" title="<?php echo $_lang["list_mode"];?>" onclick="changeListMode();return false;"><img src="<?php echo $style_path; ?>icons/table.gif" width="16" height="16"/></a></td>
				</tr>
				</table>
			</td>
			</tr>
