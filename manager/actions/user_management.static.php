...
<div class="sectionBody">
	...
	<div class="actionButtons">
		<table border="0" style="width:100%">
			<tr>
			<td><a href="index.php?a=11" class="default"><img src="<?php echo $_style["icons_add"] ?>" /> <?php echo $_lang['new_user']; ?></a></td>
			<td nowrap="nowrap">
				...
				<td><a href="#" class="default" title="<?php echo $_lang["search"];?>" onclick="searchResource();return false;"><?php echo $_lang['go']; ?></a></td>
	...
	$grd->fields       = 'id,username,fullname,email,rolename,thislogin,logincount,blocked';
	$grd->columns      = join(',', array('ID',$_lang['name'],$_lang['user_full_name'],
