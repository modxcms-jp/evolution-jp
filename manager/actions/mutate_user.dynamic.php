...
?>
		...
		<?php if($_GET['a']=='12') { ?>
		  ...
		  <tr>
			...
			<td>&nbsp;</td>
			<td><?php echo strftime($_lang["format_datetime_full"], $userdata['lastlogin']+$server_offset_time) ?></td>
		  </tr>
		  <tr>
...
?> 
	   ...
	   <tr>
          ...
          <tr>
            ...
            <td><input onchange="documentDirty=true;" type='text' maxlength='20' size='10' name="manager_lang_attribute" value="<?php echo isset($usersettings['manager_lang_attribute']) ? $usersettings['manager_lang_attribute'] : $manager_lang_attribute ; ?>" /></td>
          </tr>
          <tr>
            <td width="200">&nbsp;</td>
