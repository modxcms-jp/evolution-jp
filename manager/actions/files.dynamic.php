...
?>
<br />
<div class="sectionHeader"><?php echo $_lang['files_files']?></div><div class="sectionBody">
...
function ls($curpath) {
	...
	for($i=0; $i<$folders; $i++) {
		...
		echo '<td>',strftime($_lang["format_datetime_full"], $dirs_array[$i]['stats']['9']),'</td>';
	...
	for($i=0; $i<$files; $i++) {
		...
		echo '<td>',strftime($_lang["format_datetime_full"], $files_array[$i]['stats']['9']),'</td>';
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><textarea dir="ltr" style="width:100%; height:370px;" name="content"><?php echo htmlentities($buffer,ENT_COMPAT,$modx->config['modx_charset']);?></textarea></td>
  </tr>
</table>
</form>
<?php
