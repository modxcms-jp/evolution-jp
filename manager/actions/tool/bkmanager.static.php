                    ...
                    <p>
                        <label>
                            <input
                                ...
                                checked="checked"
                            /><?= $_lang['database_table_droptablestatements'] ?>
                        </label></p>
                    <table style="width:100%;background-color:#ccc;">
                            ...
                            <td width="160">
                                <label>
                                    <input
                                        ...
                                        type="checkbox"
                                    /><b><?= $_lang['database_table_tablename'] ?></b>
                                </label>
                            </td>
                        ...
                        while ($row = db()->getRow($rs)) {
                            ...
                            echo '<tr bgcolor="' . $bgcolor . '" title="' . $row['Comment'] . '" style="cursor:default">' . "\n" .
                                '<td><label><input type="checkbox" name="chk[]" value="' . $row['Name'] . '"' . (strstr($table_string,
                                    $row['Name']) === false ? '' : ' checked="checked"') . ' /><b style="color:#009933">' . $row['Name'] . '</b></label></td>' . "\n" .
                    ...
                    <p>
                        <label>
                            <input
                                ...
                                <?= checked(!isset($_SESSION['console_mode']) || $_SESSION['console_mode'] !== 'text') ?>
                            /> <?= $_lang["bkmgr_run_sql_file_label"] ?>
                        </label>
                        <label>
                            <input
                                type="radio"
                                ...
                                <?= checked(isset($_SESSION['console_mode']) && $_SESSION['console_mode'] === 'text') ?>
                            /> <?= $_lang["bkmgr_run_sql_direct_label"] ?>
                        </label>
                    </p>
                    <div>
                        <input
