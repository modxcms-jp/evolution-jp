    ...
    <table class="settings">
        <tr>
            ...
            <td>
                ...
                <?= lang('setting_cache_type_desc') ?>
            </td>
        </tr>
        <tr>
            <th><?= lang('setting_disable_cache_at_login') ?></th>
            <td>
                <?= wrap_label(
                    lang('enabled'),
                    form_radio(
                ...
                <?= lang('setting_disable_cache_at_login_desc') ?>
            </td>
        </tr>
        <tr>
            <th><?= lang('setting_individual_cache') ?></th>
            <td>
                <?= wrap_label(
                    lang('enabled'),
                    form_radio(
                ...
                <?= lang('setting_individual_cache_desc') ?>
            </td>
        </tr>
        <tr>
            <th><?= lang('setting_conditional_get') ?></th>
            <td>
                <?= wrap_label(
                    lang('enabled'),
                    form_radio(
                ...
                <?= lang('setting_conditional_get_desc') ?>
            </td>
        </tr>
        <tr>
            <th>旧式のキャッシュ機構</th>
