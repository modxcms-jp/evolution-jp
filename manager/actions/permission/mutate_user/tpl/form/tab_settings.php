    ...
    <tr>
        ...
        <td>
            <label><input type="radio" name="allow_manager_access"
                          value="1" <?= !isset($user['allow_manager_access']) || $user['allow_manager_access'] == 1 ? 'checked="checked"' : '' ?> /> <?= lang('yes') ?>
            </label><br/>
            <label><input type="radio" name="allow_manager_access"
                          value="0" <?= isset($user['allow_manager_access']) && $user['allow_manager_access'] == 0 ? 'checked="checked"' : '' ?> /> <?= lang('no') ?>
            </label>
