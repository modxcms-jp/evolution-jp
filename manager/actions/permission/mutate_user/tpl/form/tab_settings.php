...
<table class="settings">
    <tr>
        ...
        <td>
            <label><input type="radio" name="allow_manager_access"
                          value="1" <?php echo !isset($user['allow_manager_access']) || $user['allow_manager_access'] == 1 ? 'checked="checked"' : ''; ?> /> <?php echo lang('yes'); ?>
            </label><br/>
            <label><input type="radio" name="allow_manager_access"
                          value="0" <?php echo isset($user['allow_manager_access']) && $user['allow_manager_access'] == 0 ? 'checked="checked"' : ''; ?> /> <?php echo lang('no'); ?>
            </label>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="allowed_parents" class="inputBox"
                   value="<?php echo htmlspecialchars($user['allowed_parents']); ?>"/>
            ...
            <td>
                ...
                <a onclick="document.userform.blockedafter.value=''; return true;"
                   style="cursor:pointer; cursor:hand"><img align="absmiddle"
                                                            ...
                                                            border="0" alt="<?php echo lang('remove_date'); ?>"/></a>
            </td>
        </tr>
        <tr>
    ...
    <tr>
        ...
        <td><input type="text" maxlength='255' style="width: 300px;" name="allowed_ip"
                   value="<?php echo $user['allowed_ip']; ?>"/>
    ...
    <tr>
        ...
        <td>
            ...
            <?php echo checkbox('allowed_days[]', '3', lang('tuesday'),
                strpos($user['allowed_days'], '3') !== false); ?>
            <?php echo checkbox('allowed_days[]', '4', lang('wednesday'),
                strpos($user['allowed_days'], '4') !== false); ?>
            <?php echo checkbox('allowed_days[]', '5', lang('thursday'),
                strpos($user['allowed_days'], '5') !== false); ?>
            <?php echo checkbox('allowed_days[]', '6', lang('friday'), strpos($user['allowed_days'], '6') !== false); ?>
            <?php echo checkbox('allowed_days[]', '7', lang('saturday'),
