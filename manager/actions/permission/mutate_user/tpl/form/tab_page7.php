...
<table class="settings">
    ...
    <tr>
        ...
        <td>
            ...
            &nbsp;&nbsp;
            <label>
                <input type="checkbox" name="default_upload_images"
                    value="1" <?= isset($user['upload_images']) ? '' : 'checked' ?> />
    ...
    <tr>
        ...
        <td>
            ...
            &nbsp;&nbsp;
            <label>
                <input type="checkbox" name="default_upload_media"
                    value="1" <?= isset($user['upload_media']) ? '' : 'checked' ?> />
                    <?= lang('user_use_config') ?>
            </label>
    ...
    <tr>
        ...
        <td>
            ...
            &nbsp;&nbsp;
            <label>
                <input type="checkbox" name="default_upload_files"
                    value="1" <?= isset($user['upload_files']) ? '' : 'checked' ?> />
                <?= lang('user_use_config') ?>
            </label>
    ...
    <tr class='row2'>
        ...
        <td>
            <input type="text" maxlength='255' style="width: 300px;" name="upload_maxsize"
                value="<?= evo()->config('upload_maxsize', manager()->getUploadMaxsize()) ?>">
            <div>
                <?= sprintf(lang('upload_maxsize_message'), manager()->getUploadMaxsize()) ?>
            </div>
        </td>
    </tr>
    <tr id='rbRow1' class='row3'
        ...
        <td>
            <input type="text" maxlength='255' style="width: 300px;" name="rb_base_dir"
