                                ...
                                <table border="0" width="100%">
                                    <tr>
                                        <td nowrap="nowrap">
                                            <table border="0">
                                                <tr>
                                                    ...
                                                    <td class="actionButtons"><a href="#" title="<?php echo $_lang["search"]; ?>" onclick="searchResource();return false;"><?php echo $_lang["go"]; ?></a>
                                                    </td>
                                        ...
                                        <td width="230" class="actionButtons">
                                            <a href="#" style="float:right;margin-left:2px;" onclick="window.close()"><img src="<?php echo $_style['icons_cancel'] ?>" /> <?php echo $_lang['cancel']; ?>
                                            </a>
                                            <a href="#" style="float:right;margin-left:2px;" onclick="saveSelection()"><img src="<?php echo $_style['icons_add'] ?>" /> <?php echo $_lang['insert']; ?>
                                            </a>
                                        </td>
                                    </tr>
                                </table>
