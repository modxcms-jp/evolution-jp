            ...
            <div class="tab-pane" id="chunkPane">
                <div class="tab-page" id="tabGeneral">
                    ...
                    <div>
                        ...
                        <textarea dir="ltr" class="phptextarea" name="post"
                                  style="height:350px;width:100%"><?php echo isset($content['post']) ? htmlspecialchars($content['post']) : htmlspecialchars($content['snippet']) ?></textarea>
                    </div>
                ...
                <div class="tab-page" id="tabInfo">
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input name="published" onclick="resetpubdate();"
                                       type="checkbox"<?php echo (!isset($content['published']) || $content['published'] == 1) ? ' checked="checked"' : ''; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="pub_date" name="pub_date" type="text"
                                       value="<?php echo $content['pub_date']; ?>" class="DatePicker"/>
                                <a onclick="document.mutate.pub_date.value=''; documentDirty=true; return true;"
                                   style="cursor:pointer; cursor:hand;">
                                    <img src="<?php echo $_style["icons_cal_nodate"] ?>"
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="unpub_date" name="unpub_date" type="text"
                                       value="<?php echo $content['unpub_date']; ?>" class="DatePicker"/>
                        ...
                        <tr id="newcategry" style="display:none;">
                            ...
                            <td align="left" valign="top"><input name="newcategory" type="text" maxlength="45"
                                                                 value="<?php echo isset($content['newcategory']) ? $content['newcategory'] : '' ?>"
                        ...
                        <tr>
                            ...
                            <td align="left"><textarea name="description"
                                                       style="padding:0;height:4em;width:300px;"><?php echo htmlspecialchars($content['description']); ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th align="left" valign="middle"><?php echo $_lang['resource_opt_richtext'] ?></th>
                            <td align="left" valign="top"><input name="editor_type"
                            ...
                            <tr>
                                <td align="left" colspan="2">
                                    <label><input name="locked"
                                                  type="checkbox"<?php echo $content['locked'] == 1 || $content['locked'] == 'on' ? ' checked="checked"' : '' ?>
                                                  class="inputBox" value="on"/> <?php echo $_lang['lock_htmlsnippet'] ?>
                                        <span class="comment"><?php echo $_lang['lock_htmlsnippet_msg'] ?></span></label>
                                </td>
                            </tr>
                        <?php } ?>
                    </table>
