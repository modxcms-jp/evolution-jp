        ...
        <div class="tab-pane" id="pluginPane">
            ...
            <div class="tab-page" id="tabInfo">
                ...
                <table>
                    ...
                    <?php $pluginErrorReporting = entity('php_error_reporting', ''); ?>
                    <tr>
