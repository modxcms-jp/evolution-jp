...
?>
    ...
    <form name="mutate" id="mutate" class="module" method="post" action="index.php?a=109" enctype="multipart/form-data">
        ...
        <div class="sectionBody">
            <p><img class="icon" src="<?php echo $_style['icons_modules']; ?>" alt="."
                    style="vertical-align:middle;text-align:left;"/> <?php echo $_lang['module_msg'] ?></p>
                    ...
                    <table>
                        ...
                        <tr>
                            <td align="left" valign="top" colspan="2"><input name="disabled"
                                                                             type="checkbox" <?php echo $content['disabled'] == 1 ? 'checked="checked"' : '' ?>
                                                                             value="on" class="inputBox"/>
                                <span style="cursor:pointer"
                                      onclick="document.mutate.disabled.click();"><?php echo $content['disabled'] == 1 ? '<span class="warning">' . $_lang['module_disabled'] . '</span>' : $_lang['module_disabled'] ?></span>
                            </td>
                        </tr>
                    </table>
                    ...
                    <div style="position:relative">
                        <div style="padding:3px 8px; overflow:hidden;zoom:1; background-color:#eeeeee; border:1px solid #c3c3c3; border-bottom:none;margin-top:5px;">
                            ...
                            <span style="float:right; color:#707070"><?php echo $_lang['wrap_lines'] ?><input
                                        name="wrap"
                                        type="checkbox"<?php echo $content['wrap'] == 1 ? ' checked="checked"' : '' ?> class="inputBox"
                        ...
                        ?>
                        <textarea dir="ltr" <?php echo $readonly; ?> class="phptextarea" name="post"
                                  style="width:100%; height:370px;"
                                  wrap="<?php echo $content['wrap'] == 1 ? 'soft' : 'off' ?>"><?php echo htmlspecialchars($content['modulecode']) ?></textarea>
                    </div>
                    <!-- PHP text editor end -->
                </div>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td align="left"><textarea name="description"
                                                       style="padding:0;width:300px;height:4em;"><?php echo $content['description']; ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td align="left"><input type="text" maxlength="255" style="width: 235px;" name="icon"
                                                    value="<?php echo $content['icon'] ?>"/> <input type="button"
                                                                                                    value="<?php echo $_lang['insert'] ?>"
                                                                                                    onclick="BrowseServer();"/>
                            </td>
                        </tr>
                        <tr style="display:none;">
                            <td align="left"><input name="enable_resource"
                                                    title="<?php echo $_lang['enable_resource'] ?>"
                                                    type="checkbox"<?php echo $content['enable_resource'] == 1 ? ' checked="checked"' : '' ?>
                                                    class="inputBox"/> <span style="cursor:pointer"
                                                                             onclick="document.mutate.enable_resource.click();"
                                                                             title="<?php echo $_lang['enable_resource'] ?>"><?php echo $_lang["element"] ?></span>:
                            </td>
                            <td align="left"><input name="resourcefile" type="text" maxlength="255"
                                                    value="<?php echo $content['resourcefile'] ?>" class="inputBox"/>
                            </td>
                        </tr>
                        <?php if ($modx->hasPermission('save_module') == 1) { ?>
                            <tr>
                                <td align="left" valign="top" colspan="2"><input name="locked"
                                                                                 ...
                                                                                 class="inputBox"/>
                                    <span style="cursor:pointer"
                                          onclick="document.mutate.locked.click();"><?php echo $_lang['lock_module'] ?></span>
                                    <span class="comment"><?php echo $_lang['lock_module_msg'] ?></span></td>
                            </tr>
                        <?php } ?>
                        <tr>
                            <td align="left" valign="top"><?php echo $_lang['module_config'] ?>:</td>
                            <td align="left" valign="top"><textarea name="properties" style="display:block;"
                                                                    maxlength="65535" class="inputBox phptextarea"
                                                                    onchange="showParameters(this);"/><?php echo $content['properties'] ?></textarea>
                                <input type="button" value="<?php echo $_lang['update_params'] ?>"
                                       style="width:16px; margin-left:2px;"
                                       title="<?php echo $_lang['update_params'] ?>"/></td>
                        </tr>
                ...
                <?php } elseif ($_REQUEST['a'] == '108') { ?>
                    ...
                    <div class="tab-page" id="tabDepend">
                        ...
                        <div class="sectionBody">
                            ...
                            <table>
                                <tr>
                                    <td align="left" valign="top" colspan="2"><input name="enable_sharedparams"
                                                                                     type="checkbox"<?php echo $content['enable_sharedparams'] == 1 ? ' checked="checked"' : '' ?>
                                                                                     class="inputBox"/> <span
                                                style="cursor:pointer"
                                                onclick="document.mutate.enable_sharedparams.click();"><?php echo $_lang['enable_sharedparams'] ?>:</span>
                                    </td>
                                </tr>
                                <tr class="sharedparams" <?php echo $display; ?>>
                                    <td align="left" valign="top"><?php echo $_lang['guid'] ?>:</td>
                                    <td align="left" valign="top"><input name="guid" type="text" maxlength="32"
                                                                         value="<?php echo ($content['guid'] != '') ? $content['guid'] : createGUID(); ?>"
                                                                         class="inputBox"/><br/>
                        ...
                        <div class="sectionBody sharedparams" <?php echo $display; ?>>
                            ...
                            <p class="actionButtons" style="float:none;overflow:hidden;zoom:1">
                                <a href="#" onclick="loadDependencies();return false;"><img
                                            src="<?php echo $_style["icons_edit_document"] ?>"
                                            align="absmiddle"/> <?php echo $_lang['manage_depends'] ?></a></p>
                            <?php
