...
<script type="text/javascript">
    ...
    // Resource browser (シェル内はモーダル、chromelessはポップアップ)
...
<form name="mutate" id="mutate" class="module" method="post" action="index.php?a=109" enctype="multipart/form-data">
    ...
    <div class="sectionBody">
        <p><img class="icon" src="<?= $_style['icons_modules'] ?>" alt="."
                style="vertical-align:middle;text-align:left;" /> <?= $_lang['module_msg'] ?></p>
