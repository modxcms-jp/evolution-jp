...
<form name="mutate" id="mutate" method="post" action="index.php" enctype="multipart/form-data">
    ...
    <h1><?php echo $_lang['tmplvars_title'];
        if ($id) {
            echo "(ID:{$id})";
        } ?></h1>
                ...
                <table>
                    <tr>
                        ...
                        <td align="left"><span style="font-family:'Courier New', Courier, mono">[*</span><input
                                    ...
                                    value="<?php echo htmlspecialchars($content['name']); ?>" class="inputBox"
                    ...
                    <tr>
                        ...
                        <td align="left"><input name="caption" type="text" maxlength="80"
                                                value="<?php echo htmlspecialchars($content['caption']); ?>"
                    ...
                    <tr>
                        ...
                        <td align="left" nowrap="nowrap"><textarea name="default_text" type="text"
                                                                   ...
                                                                   style="width:400px;"><?php echo htmlspecialchars($content['default_text']); ?></textarea><?php echo $tooltip_tv_binding; ?>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <select name="display" size="1" class="inputBox" style="width:400px;"
                                ...
                                <option value="custom_widget" <?php echo selected($content['display'] === 'custom_widget'); ?>>
                                    Custom Processor
                                </option>
                                <option value="image" <?php echo selected($content['display'] === 'image'); ?>>Image
                                </option>
                                <option value="hyperlink" <?php echo selected($content['display'] === 'hyperlink'); ?>>
                                    Hyperlink
                                </option>
                                <option value="htmltag" <?php echo selected($content['display'] === 'htmltag'); ?>>HTML
                                    Generic Tag
                                </option>
                                <option value="string" <?php echo selected($content['display'] === 'string'); ?>>String
                                    Formatter
                                </option>
                                <option value="date" <?php echo selected($content['display'] === 'date'); ?>>Date
                                    Formatter
                                </option>
                                <option value="unixtime" <?php echo selected($content['display'] === 'unixtime'); ?>>
                                    Unixtime
                                </option>
                                <option value="delim" <?php echo selected($content['display'] === 'delim'); ?>>Delimited
                                    List
                                </option>
                                <option value="datagrid" <?php echo selected($content['display'] === 'datagrid'); ?>>
                                    Data Grid
                                </option>
                            </select>
                        </td>
                ...
                <table>
                    ...
                    <tr id="newcategry" style="display:none;">
                        <th align="left" valign="top"
                            style="padding-top:5px;"><?php echo $_lang['new_category']; ?></th>
                    ...
                    <tr>
                        ...
                        <td align="left"><textarea name="description"
                                                   style="padding:0;height:4em;"><?php echo htmlspecialchars($content['description']); ?></textarea>
                        </td>
                    </tr>
                    <?php if ($modx->hasPermission('save_template') == 1) { ?>
                        <tr>
                            <td align="left" colspan="2"><label><input name="locked" value="on"
                                                                       ...
                                                                       class="inputBox"/>
                                    <b><?php echo $_lang['lock_tmplvars']; ?></b> <span
                                            class="comment"><?php echo $_lang['lock_tmplvars_msg']; ?></span></label>
                            </td>
                        </tr>
                    <?php } ?>
                    <tr>
                        ...
                        <td align="left"><input name="rank" type="text" maxlength="4"
                                                value="<?php echo (isset($content['rank'])) ? $content['rank'] : 0; ?>"
                                                class="inputBox" style="width:300px;"></td>
                    </tr>
                </table>
            </div>
