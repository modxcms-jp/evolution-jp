...
if (isset($_REQUEST['t']))     $sql = sprintf('OPTIMIZE TABLE `%s`', $modx->db->escape($_REQUEST['t']));
elseif (isset($_REQUEST['u'])) $sql = sprintf('TRUNCATE TABLE `%s`', $modx->db->escape($_REQUEST['u']));
