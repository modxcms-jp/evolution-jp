...
$sqlParser = new SqlParser($table_prefix, $adminname, $adminemail, $adminpass, $database_connection_charset, $database_collation, $managerlanguage, $database_connection_method, $auto_template_logic);
