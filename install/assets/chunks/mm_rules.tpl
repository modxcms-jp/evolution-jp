 ...
 * mm_demo_rules
 * 
 * サンプルサイト用のManagerManagerルール <strong style="color:#CC0000;">【注意】</strong>このルールが有効になっている場合は投稿画面がMODx標準の状態と異なっているためご注意ください。インストール後ManagerManager プラグインを無効にして見比べてみることをおすすめします。
 * 
 * @category	chunk
 * @version 	1.0.1
...
// For everyone
// mm_default('pub_date');
mm_default('pub_date', 'return date("Y/m/d H:i:s");','','',true);
// mm_renameField('introtext','ページの要約');
