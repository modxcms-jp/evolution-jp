...
('signupemail_message','こんにちは  [+uid+]さん \r\n\r\n[+sname+] の管理画面へのログイン情報をお送りします。:\r\n\r\nユーザー名: [+uid+]\r\nパスワード: [+pwd+]\r\n\r\n[+surl+]の管理画面へログイン後、パスワードの変更ができます。\r\n\r\n[+sname+] 管理者'),
('websignupemail_message','こんにちは [+uid+]さん\r\n\r\n [+sname+]へのログイン情報をお送りします。\r\n \r\nユーザー名: [+uid+]\r\nパスワード: [+pwd+]\r\n\r\n[+surl+]のマネージャーへログイン後、パスワードの変更ができます。\r\n\r\n\r\n[+sname+] 管理者'),
('webpwdreminder_message','こんにちは、[+uid+]さん\r\n\r\nパスワードを有効化するために、下記のリンクをクリックしてください。:\r\n\r\n[+surl+]\r\n\r\n有効化が完了後、下記のパスワードでログインできます。:\r\n\r\nパスワード:[+pwd+]\r\n\r\nこのメール内容に心当たりがない場合は、破棄してください。\r\nIf you did not request this email then please ignore it.\r\n\r\n[+sname+] 管理者'),
('number_of_logs','100'),
