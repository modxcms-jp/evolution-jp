...
$_lang["connection_screen_server_connection_note"] = 'ポート番号を指定する場合は「ホスト名:ポート番号」とします(例：localhost:3306)。<br />※Webサーバがデータベースサーバを兼ねる場合はデータベースホスト名を<a href="http://www.google.com/search?q=localhost&lr=lang_ja" target="_blank">「localhost」</a>とします。さくらインターネット・ロリポップ・エックスサーバーなど一部のレンタルサーバでは専用のホストを指定します。';
...
$_lang["iagree_box"] = '<b><a href="../assets/docs/license.txt" target="_blank">このライセンス(GPL2)</a>で規定される諸条件に同意します。</b></p><p><a href="http://www.opensource.jp/gpl/gpl.ja.html" target="_blank">GPL2ライセンスの日本語訳はこちらにあります。</a>この翻訳には法的効力はないため、法的検証が必要な場合は英語の原文をご確認ください。';
...
$_lang["loading"] = '処理中...';
$_lang["modules"] = 'モジュール';
$_lang["modx_footer1"] = '&copy; 2005-2011 the <a href="http://modx.com/" target="_blank"">MODX</a> Content Management Framework (CMF) project. All rights reserved. MODX is licensed under the GNU GPL.';
