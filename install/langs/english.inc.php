...
$_lang["alert_enter_adminemail"] = 'You need to enter an email address for the system admin account!';
...
$_lang["install_config_remote_hint"] = 'IP address to add to <span class="mono">allowed_ips</span>';
$_lang["install_config_step1"] = 'Copy <span class="mono">%2$s</span> in <span class="mono">%1$s</span> as <span class="mono">%3$s</span>.';
$_lang["install_config_step2"] = 'Set allowed IP addresses (<span class="mono">allowed_ips</span>) or BASIC authentication.';
$_lang["install_config_step3"] = 'Reload this page after saving the configuration file.';
$_lang["install_config_footer"] = 'Leaving both empty disables access control, which is not recommended.';
