...
$_lang["iagree_box"] = 'Я согласен с условиями <a href="license.txt" target="_blank">лицензии</a>. С русским переводом текста лицензии можно познакомиться на странице <a href="http://ru.wikipedia.org/wiki/GPL" target="_blank">GNU General Public License</a>.';
...
$_lang["welcome_message_upd_text"] = 'MODX обновления легко. Пожалуйста, действуйте, как описано в программе установки.';
$_lang["welcome_message_upd_welcome"] = 'Запустить обновление MODX';
$_lang["begin_install_msg"] = '<p>Конфигурационный файл MODX не найден. </p><p>Вы хотите установить MODX?<p>';

$_lang["help_link_new"] = 'http://modx.jp/docs/install.html';
$_lang["help_link_upd"] = 'http://modx.jp/docs/update.html';

$_lang["optional_items_new_note"]="Это новая установка. Выберите дополнительные опции";
$_lang["optional_items_upd_note"]="Это обновление. Выберите дополнительные опции";
