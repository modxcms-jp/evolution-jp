...
- **決定**: `assets/docs/logging-debugging.md` の詳細計画は ExecPlan に移し、実装の正本を `.agent/plans/2026-05-01-fatal-log-observability.md` に置く
- **理由**:
...
- 設計メモの移行元: `assets/docs/logging-debugging.md`
