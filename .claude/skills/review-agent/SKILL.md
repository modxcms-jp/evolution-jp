...
# DISMISSED を除外し、各レビュアーの最新レビューのみに絞り込む手順は次のとおり:
# gh api --paginate "/repos/{owner}/{repo}/pulls/<PR番号>/reviews" | python3 -c "
import sys, json
...
for r in latest.values():
    print(r['state'], r['user']['login'], r['body'][:80] if r['body'] else '')
"
